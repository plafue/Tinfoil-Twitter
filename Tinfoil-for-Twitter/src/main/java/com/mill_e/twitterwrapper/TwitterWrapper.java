...
import com.mill_e.twitterwrapper.activity.BaseTwitterWebViewActivity;
import com.mill_e.twitterwrapper.preferences.TwitterPreferences;
...
public class TwitterWrapper extends BaseTwitterWebViewActivity {
     ...
     * Most preferences will be automatically set for the {@link com.mill_e.twitterwrapper.webview.TwitterWebView}.
     */
    private void loadPreferences() {
        ...
        if (!mSharedPreferences.getBoolean(TwitterPreferences.MENU_DRAWER_SHOWED_OPENED, false)) {
            openMenuDrawer();

            // Make sure we don't auto-open the menu ever again
            SharedPreferences.Editor editor = mSharedPreferences.edit();
            editor.putBoolean(TwitterPreferences.MENU_DRAWER_SHOWED_OPENED, true);
            editor.apply();
        }
    ...
    /**
     * Configure this {@link com.mill_e.twitterwrapper.webview.TwitterWebView}
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.menu_preferences:
                    startActivity(new Intent(TwitterWrapper.this, TwitterPreferences.class));
                    break;
